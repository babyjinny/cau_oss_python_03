...
class line:
    ...
    def set_length(self, width, height):
        ...
        Args:
            ...
            length (int or float): 수정하고자 하는 선의 세로 길이
        """
        self.__width = width
        self.__height = height
...
def area_rectangle(width, height):
    ...
    Args:
        width (int of float): 밑변(가로)의 길이
        height (int of float): 높이(세로)의 길이
    Returns:
...
def area_ellipse(width, height):
    ...
    Args:
        width (int or float): 짧은 반지름의 길이
        height (int or float): 긴 반지름의 길이
    Returns:
